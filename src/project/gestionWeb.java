...
public class gestionWeb extends JPanel implements ActionListener {
    ...
    public gestionWeb() {
        ...
        JTextField textWebOld = new JTextField();
        ...
        JTextField newWeb = new JTextField();
        ...
        JButton backButton2 = new JButton("Volver atrás");
        ...
        confirmAdd.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(ActionEvent e) {
        		...
        		try (PreparedStatement statementWeb = con.prepareStatement(insertWeb)){
        			...
        			JOptionPane.showMessageDialog(null, "Error al aÃ±adir una localizacion");
					e1.printStackTrace();
				}
			}
        });
        ...
        add(mainPanel, BorderLayout.CENTER); // Añadir el panel con los formularios al panel principal
        }
    ...
    private void delWeb() {
        ...
        if (nombreWeb != null && !nombreWeb.trim().isEmpty()) {  // Comprobar que el nombre no esté vacío
  ...
  //METODO PARA ACTUALIZAR LOS DATOS DE UNA WEB
    private void updateWeb() {
        ...
        // Pedir al usuario el nombre de la web que desea actualizar
        String nombreWeb = JOptionPane.showInputDialog("Introduce el nombre de la web a modificar:");
        String nuevaURL = JOptionPane.showInputDialog("Introduce la nueva URL para la web:");
        String nuevaWeb = JOptionPane.showInputDialog("Introduce el nuevo nombre para la web:");
        
        // Comprobar que el nombre y la URL no estén vacíos
